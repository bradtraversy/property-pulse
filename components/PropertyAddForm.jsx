...
const PropertyAddForm = () => {
  ...
  const handleImageChange = (e) => {
    ...
    if (totalImagesAfterAdd > maxImages) {
      ...
      toast.error(`You can select up to ${maxImages} images in total.`);
    ...
    // Proceed with adding files to the state if within the limit
    const updatedImages = [...fields.images, ...Array.from(files)];
